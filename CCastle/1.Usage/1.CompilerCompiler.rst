...
.. use:: Castle has build-in grammers support
   ...
   In Castle one can define a grammer directly into the source-code; as :ref:`grammmar-code`!
...
:ref:`matching-statements` to simply. Curious on how that works: continue reading in :ref:`grammmar-code`.
