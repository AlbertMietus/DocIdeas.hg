...
flow through the network and kind of represent state.
|BR|
...
any algebra, it has (transformation) “rules”.  So that one calculates [#bool-algebra]_ and *measures* some
characteristics.
...
|BR|
That expect, by example is needed for the :ref:`CC-example-Sieve`.
|BR|
