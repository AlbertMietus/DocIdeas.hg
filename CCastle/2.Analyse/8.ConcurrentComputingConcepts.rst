...
answer-messages, and that answer is returned. This can be seen as a layer on top of the send/receive more fundamental
calls. An famous example is RPC_: the Remote ProcedureCall.
...
|BR|
Typically, the developer will to “cycle” to poll for a profitable call; and let the task do some other/background work
as well.
