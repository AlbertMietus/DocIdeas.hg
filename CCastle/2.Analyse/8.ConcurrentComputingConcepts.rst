...
CSP_ is probably the oldest and best known *formal* language to describe (patterns in) concurrent systems. I started in
1978 as a kind of programming language, and has evolved since them.  Occam_ --the language to program the one famous
Transputer_-- is based on CSP_.
...
Also ACP_ dates back from 1982 and is a real algebra -- it probably contrive the general term Process-Calculus_ 
