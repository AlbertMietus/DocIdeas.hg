...
.. code-block:: jinja
   ...
   {%macro EventIndexName(compName, portName) -%}
      CC_P_{{ProtoName}}_{{EventtName}}
   {%- endmacro %}

   {# to be used as: #}
   {%macro EventIndex((compName, portName, indexNo) %} {{EventIndexName(compName, portName)}} = {{indexNo}} }}{% endmacro %}
