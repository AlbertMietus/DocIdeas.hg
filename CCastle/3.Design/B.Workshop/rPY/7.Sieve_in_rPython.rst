...
.. code-block:: python
   ...
   receiver = self.outlet.connection
   self.outlet.handlers[SimpleSieve.CC_P_SimpleSieve_input](receiver, i)
   # Note: this assumes there is always a valid method in all entries of the DispatchTable
...
.. [#arbitrary]
   ...
   events are copied down, and (b) empty slots will contain the generic error function [#RT]_.
